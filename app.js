      ...
      {items.map((item) => (
        <div
          ...
          style={{
            ...
            height: item.size,
            borderRadius: "50%",
            background: "linear-gradient(135deg,#f9c5d1,#e8b4e8)",
            display: "flex",
            alignItems: "center",
            justifyContent: "center",
            fontSize: `calc(${item.size} * 0.5)`,
            animation: `yuaFloat ${item.dur} ease-in forwards`,
            animationDelay: item.delay,
            border: "3px solid #d4a0d0",
            boxShadow: "0 0 12px rgba(212,160,208,0.6)",
          }}
        >
          🐾
        </div>
    ...
    <div style={{
      ...
      <div style={{
        ...
        <p style={{ fontSize: 17, fontWeight: 700, color: "#8b3a8b", margin: "0 0 20px", lineHeight: 1.4 }}>
          Simdi 5 saniye bekle koca bebek 🤗
        </p>
        <div style={{
...
function App() {
  ...
  const [step, setStep] = useState(savedState?.step || STEPS.S1_ENTRY);
  const [giftStyle, setGiftStyle] = useState(savedState?.giftStyle || null);
  ...
  const go = useCallback((nextStep, extra = {}) => {
    const newState = { step: nextStep, giftStyle: extra.giftStyle ?? giftStyle };
    saveState(newState);
    setStep(nextStep);
    ...
    switch (step) {
        ...
        return (
          <div className="screen slide-in" key={key}>
            ...
            <div className={`card ${shakeCard ? "shake" : ""}`}>
              ...
              <button className="btn btn-secondary" onClick={() => showPopup("Eşeklik etme 😤")}>
      ...
      case STEPS.S1_2_DATE:
        return (
          <div className="screen slide-in" key={key}>
            ...
            <div className={`card ${shakeCard ? "shake" : ""}`}>
              <span className="emoji-big">📅</span>
              <div className="title">Tanışma tarihimiz 💕</div>
              <input
                className="input-field"
                type="date"
                value={dateInput}
      ...
      case STEPS.S2_ROUTE:
        return (
          <div className="screen slide-in" key={key}>
            <Stars />
            <div className="stage-badge">✅ Doğrulama Başarılı</div>
            <div className="card">
              <span className="emoji-big">🤔</span>
        ...
        return (
          <div className="screen slide-in" key={key}>
            ...
            <div className="card">
              ...
              <button className="btn btn-secondary" onClick={() => { triggerShake(); showPopup("Mantıklı ama tekrar dene 😅"); }}>
      ...
      case STEPS.S3_KASA:
        return (
          <div className="screen slide-in" key={key}>
            <Stars />
            <div className="stage-badge">🔐 Aşama 3: Şifre Çözücü</div>
      ...
      case STEPS.S4:
        return (
          <div className="screen slide-in" key={key}>
            <Stars />
            <div className="stage-badge">🔐 Şifre Çözücü</div>
            <div className="card" style={{ textAlign: "center" }}>
              <span className="emoji-big">💖</span>
              <div className="title">Benim için dünyanın en özel, en tatlı, en sevilesi çocuğu kim?</div>
              <button className="btn btn-primary" onClick={() => { showPopup("Tabikide sen 💖"); setTimeout(() => go(STEPS.S5), 2400); }}>
                Ben tabiki 👑
              </button>
            </div>
          </div>
        ...
        return (
          <div className="screen slide-in" key={key}>
            ...
            <div className="card">
              ...
              <button className="btn btn-secondary" onClick={() => showPopup("Nasıl bilmezsin koca bebek! Tekrar düşün. 🤔")}>
                A) Bilmiyorum ki 🤷
              </button>
        ...
        return (
          <div className="screen slide-in" key={key}>
            ...
            <div className="card">
              ...
              <button className="btn btn-primary" onClick={() => go(STEPS.S7)}>
                A) Çoook usluydum 😇
              </button>
              <button className="btn btn-secondary" onClick={() => { showPopup("Yoo 🥰🥰"); setTimeout(() => go(STEPS.S7), 2400); }}>
      ...
      case STEPS.S7:
        return (
          <div className="screen slide-in" key={key}>
            <Stars />
            <div className="stage-badge">🎁 Son Adım!</div>
            <div className="card">
              <span className="emoji-big">🎁</span>
      ...
      case STEPS.FINAL:
        return (
          <FinalScreen giftStyle={giftStyle} onConfetti={() => setShowConfetti(true)} onCopy={handleCopy} copied={copied} />
        );
  ...
  return (
    <>
      ...
      >
        {renderStep()}
        {popup && <Popup text={popup} onClose={() => setPopup(null)} />}
...
function FinalScreen({ giftStyle, onConfetti, onCopy, copied }) {
      ...
      <div style={{ position: "relative", zIndex: 1, width: "100%" }}>
        {!opened ? (
          <div style={{ textAlign: "center", padding: "20px 0" }}>
            ...
            <p style={{ fontSize: 15, color: "#b060b0" }}>Dokunmaya kork 🤭</p>
          </div>
        ) : (
          <div style={{ animation: "popIn 0.5s cubic-bezier(.34,1.56,.64,1)" }}>
            <div style={{ textAlign: "center", marginBottom: 24 }}>
              ...
              <h1 style={{
                fontFamily: "'Fredoka One', cursive",
                fontSize: 28, color: "#6a1a6a",
                margin: "12px 0 6px",
                textShadow: "0 2px 12px rgba(180,80,200,0.2)",
              }}>İyi Çocuklar Günü!</h1>
              <p style={{ fontSize: 15, color: "#9b4a9b", lineHeight: 1.5 }}>
                Seni çok seviyorum 💖
              </p>
            </div>
